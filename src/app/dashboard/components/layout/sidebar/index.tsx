"use client";
import { LayoutDashboard, ChevronDown, Heart,Home, LucideProps , Mail, User, Search, SquarePlus } from "lucide-react";
...
const SettingsSidebar: FC<Iproperties> = ({ sideNavitems = sideItems }) => {
  ...
  return (
    <div className="h-screen flex w-[50px] flex-col gap-11 items-center justify-center bg-white-200 pt-6  md:w-[275px] md:justify-start ">
      <section className="pr-4  flex flex-col items-center gap-y-3 items-stretch">
        ...
        {addNewListingLinks.map((item, index) => (
          ...
          >
            <div className="flex items-center justify-start gap-2">
              {item.icon && <item.icon className="w-[18px] h-[18px]" role="sidebar-icon" />}
